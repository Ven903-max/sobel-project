set moduleName Loop_StoreLoop_proc
set isTopModule 0
...
set C_modelName {Loop_StoreLoop_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 1}  }
	{ out_r int 64 regular {fifo 0}  }
	{ out_img int 8 regular {array 262144 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "out_img", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_img_address0 sc_out sc_lv 18 signal 2 } 
	{ out_img_ce0 sc_out sc_logic 1 signal 2 } 
	{ out_img_q0 sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_img_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "out_img", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "out_img", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0"}],
		"Loop" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "262153", "Max" : "262153"}
	, {"Name" : "Interval", "Min" : "262153", "Max" : "262153"}
]}
...
set Spec2ImplPortList { 
	...
	out_img { ap_memory {  { out_img_address0 mem_address 1 18 }  { out_img_ce0 mem_ce 1 1 }  { out_img_q0 mem_dout 0 8 } } }
}
set moduleName Loop_StoreLoop_proc
set isTopModule 0
set isCombinational 0
