set moduleName Loop_LoadLoop_proc
set isTopModule 0
...
set C_modelName {Loop_LoadLoop_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ in_img int 8 regular {array 262144 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "in_img", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_img_address0 sc_out sc_lv 18 signal 2 } 
	{ in_img_ce0 sc_out sc_logic 1 signal 2 } 
	{ in_img_we0 sc_out sc_logic 1 signal 2 } 
	{ in_img_d0 sc_out sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_img_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_img", "role": "we0" }} , 
 	{ "name": "in_img_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_img", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "in_img", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0"}],
		"Loop" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "262155", "Max" : "262155"}
	, {"Name" : "Interval", "Min" : "262155", "Max" : "262155"}
]}
...
set Spec2ImplPortList { 
	...
	in_img { ap_memory {  { in_img_address0 mem_address 1 18 }  { in_img_ce0 mem_ce 1 1 }  { in_img_we0 mem_we 1 1 }  { in_img_d0 mem_din 1 8 } } }
}
set moduleName Loop_LoadLoop_proc
set isTopModule 0
set isCombinational 0
