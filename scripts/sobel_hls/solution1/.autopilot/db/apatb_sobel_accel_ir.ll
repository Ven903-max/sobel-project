; ModuleID = '/home/ven_903/sobel-update2/scripts/sobel_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sobel_accel_ir(%"struct.ap_uint<8>"* noalias nocapture nonnull readonly "maxi" %in, %"struct.ap_uint<8>"* noalias nocapture nonnull "maxi" %out) local_unnamed_addr #0 {
entry:
  %in_copy = alloca i8, align 512
  %out_copy = alloca i8, align 512
  call fastcc void @copy_in(%"struct.ap_uint<8>"* nonnull %in, i8* nonnull align 512 %in_copy, %"struct.ap_uint<8>"* nonnull %out, i8* nonnull align 512 %out_copy)
  call void @apatb_sobel_accel_hw(i8* %in_copy, i8* %out_copy)
  call void @copy_back(%"struct.ap_uint<8>"* %in, i8* %in_copy, %"struct.ap_uint<8>"* %out, i8* %out_copy)
  ret void
}
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<8>.14"(i8* align 512 %3, %"struct.ap_uint<8>"* %2)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<8>.14"(i8* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<8>"* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_sobel_accel_hw(i8*, i8*)
...
define void @sobel_accel_hw_stub_wrapper(i8*, i8*) #4 {
entry:
  %2 = alloca %"struct.ap_uint<8>"
  %3 = alloca %"struct.ap_uint<8>"
  call void @copy_out(%"struct.ap_uint<8>"* %2, i8* %0, %"struct.ap_uint<8>"* %3, i8* %1)
  call void @sobel_accel_hw_stub(%"struct.ap_uint<8>"* %2, %"struct.ap_uint<8>"* %3)
  call void @copy_in(%"struct.ap_uint<8>"* %2, i8* %0, %"struct.ap_uint<8>"* %3, i8* %1)
  ret void
}

declare void @sobel_accel_hw_stub(%"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*)
