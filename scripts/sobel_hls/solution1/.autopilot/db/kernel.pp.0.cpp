...
void sobel_filter(pixel_t in_img[512][512],
                  pixel_t out_img[512][512]);
# 5 "../src/kernel.h" 2


extern "C" {
__attribute__((sdx_kernel("sobel_accel", 0))) void sobel_accel(pixel_t *in, pixel_t *out);
}
# 2 "../src/kernel.cpp" 2

extern "C" {
__attribute__((sdx_kernel("sobel_accel", 0))) void sobel_accel(pixel_t *in, pixel_t *out) {
#line 3 "/home/ven_903/sobel-update2/scripts/fix_export.tcl"
#pragma HLSDIRECTIVE TOP name=sobel_accel
# 4 "../src/kernel.cpp"
...
LoadLoop:
    for(int r=0; r<512; r++) {
        VITIS_LOOP_19_1: for(int c=0; c<512; c++) {
#pragma HLS PIPELINE II=1
 in_img[r][c] = in[r*512 + c];
        }
    }
...
StoreLoop:
    for(int r=0; r<512; r++) {
        VITIS_LOOP_31_2: for(int c=0; c<512; c++) {
#pragma HLS PIPELINE II=1
 out[r*512 + c] = out_img[r][c];
        }
    }
}
}
